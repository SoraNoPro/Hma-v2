...
ImageButton1.Image = "http://www.roblox.com/asset/?id=18918134486"
...
local LogoHub = Instance.new("ImageLabel")
    ...
    LogoHub.Image = "http://www.roblox.com/asset/?id=18918134486"..tostring(12523036534)
...
local Library = Update:Window("           Sora","12523036534",Enum.KeyCode.RightControl);
...
H:AddLabel("Wellcone To Script SoraHub")
            ...
            if FarmMode == "Normal" and _G.AutoFarm then
                pcall(function()
                    ...
                    if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
						...
						BTP(CFrameQuest)
						elseif (game.Players.LocalPlayer.Character.HumanoidRoot.Position - CFrameQuest.Position).Magnitude < 1500 then
						TP1(CFrameQuest)
						end
					else
						TP1(CFrameQuest)
